...
const FinalCTAComponent=({onStartFreeTrial,onExploreDemo})=>(0,F.jsxs)("section",{id:"final-cta",className:"relative overflow-hidden bg-gradient-to-b from-[#0B192C] via-[#0D243F] to-[#0A192F] text-white py-20 lg:py-28",children:[
  (0,F.jsx)("div",{className:"absolute inset-0 opacity-5 pointer-events-none bg-[radial-gradient(#10B981_1px,transparent_1px)] [background-size:24px_24px]"}),
...
Jt=({business:e,onLogout:t,onGoToLanding:n})=>{
  ...
  let normalizedRole = (currentRole || "Owner").toLowerCase().trim();
  let isOwner = normalizedRole === "owner" || normalizedRole === "platform-admin" || normalizedRole === "business-owner";

  const ROLE_ALLOWED_TABS = {
    owner: [
      "overview", "sales", "expenses", "inventory", "invoices",
      "customers", "suppliers", "compliance", "marketing",
      "analytics", "ai-advisor", "ai-assist", "news", "training", "settings", "platform-admin"
    ],
    manager: [
  ...
  let allowedTabIds = isOwner ? ROLE_ALLOWED_TABS.owner : (ROLE_ALLOWED_TABS[normalizedRole] || ROLE_ALLOWED_TABS.owner);

  let normalizeTabId = (tab) => {
    if (!tab) return "overview";
    if (tab === "ai-assist") return "ai-advisor";
    return tab;
  };

  let isTabAllowed = (tab) => {
    if (isOwner) return true;
    let nTab = normalizeTabId(tab);
    return allowedTabIds.includes(nTab) || allowedTabIds.includes(tab);
  };

  // Sync active tab when role changes
  (0, _.useEffect)(() => {
    if (!isTabAllowed(r)) {
      i(allowedTabIds[0] || "overview");
    }
  }, [normalizedRole]);

  let handleNotifNavigate = (rawTab, notif) => {
    let targetTab = normalizeTabId(rawTab);
  ...
  let visibleNavItems = te.filter(item => {
    if (item.id === "platform-admin") {
      ...
      return isOwner || (u && u.role === "platform-admin");
    }
      ...
      (0, F.jsxs)('div', {
        ...
        children: [
          ...
          (0, F.jsx)("main", {
            ...
            children: !isTabAllowed(r) ? (0, F.jsxs)("div", {
              ...
              children: [
                ...
                (0, F.jsx)("button", {
                  onClick: () => i(isOwner ? "overview" : (allowedTabIds[0] || "sales")),
              ...
              children: [
                r === 'overview' && (0, F.jsx)(Nt, {
                  ...
                  products: b,
                  invoices: x,
                  onNavigateTab: target => { let t = target === 'ai-assist' ? 'ai-advisor' : target; i(t); },
                ...
                (r === 'ai-advisor' || r === 'ai-assist') && (0, F.jsx)(Wt, {
                  business: g,
                  sales: v,
                  expenses: y
                }),
...
function I(){let[e,t]=(0,_.useState)(()=>O.getCurrentUser()),[n,r]=(0,_.useState)(()=>O.getActiveBusiness()),[i,a]=(0,_.useState)(function(){try{var p=window.location.pathname;if(p==="/features/cash-flow-finance")return"feature-cash-flow-finance";if(p==="/features/tax-compliance")return"feature-tax-compliance";if(p==="/features/inventory-operations")return"feature-inventory-operations";if(p==="/features/customers-whatsapp-crm")return"feature-customers-whatsapp-crm";if(p==="/features/business-intelligence-growth")return"feature-business-intelligence-growth";}catch(e){}return"landing";}),[o,s]=(0,_.useState)(!1),[c,l]=(0,_.useState)(`login`);(0,_.useEffect)(()=>{let e=O.getCurrentUser(),n=O.getActiveBusiness();t(e),r(n)},[]);let u=e=>{l(e),s(!0)},d=()=>{let e=O.getCurrentUser(),n=O.getActiveBusiness();t(e),s(!1),n?(r(n),a(`dashboard`)):a(`onboarding`)},f=()=>{s(!1),a(`onboarding`)},p=()=>{let e=O.getActiveBusiness();r(e),a(`dashboard`)},m=()=>{O.logout(),t(null),r(null),a(`landing`)},h=()=>{O.loginDemoUser();let e=O.getCurrentUser(),n=O.getActiveBusiness();t(e),r(n),a(`dashboard`)},goToFeature=function(featId){var pageKey=featId==="cash-flow"?"cash-flow-finance":featId==="tax-compliance"?"tax-compliance":featId==="inventory-ops"?"inventory-operations":featId==="customers-crm"?"customers-whatsapp-crm":featId==="intelligence-growth"?"business-intelligence-growth":featId;try{var targetPath="/features/"+pageKey;if(window.location.pathname!==targetPath){window.history.pushState({feature:pageKey},"",targetPath);}}catch(e){}a("feature-"+pageKey);if(typeof window!=="undefined"){window.scrollTo({top:0,behavior:"smooth"});}},goHome=function(sectionId){try{if(window.location.pathname!=="/"){window.history.pushState({},"","/");}}catch(e){}a("landing");if(sectionId){setTimeout(function(){var t=document.getElementById(sectionId);t&&t.scrollIntoView({behavior:"smooth"});},100);}else if(typeof window!=="undefined"){window.scrollTo({top:0,behavior:"smooth"});}},g=function(e){if(i!=="landing"){goHome(e);}else{var t=document.getElementById(e);t&&t.scrollIntoView({behavior:"smooth"});}};(0,_.useEffect)(function(){var handlePop=function(){var p=window.location.pathname;if(p==="/features/cash-flow-finance")a("feature-cash-flow-finance");else if(p==="/features/tax-compliance")a("feature-tax-compliance");else if(p==="/features/inventory-operations")a("feature-inventory-operations");else if(p==="/features/customers-whatsapp-crm")a("feature-customers-whatsapp-crm");else if(p==="/features/business-intelligence-growth")a("feature-business-intelligence-growth");else if(i.startsWith("feature-"))a("landing");};window.addEventListener("popstate",handlePop);return function(){window.removeEventListener("popstate",handlePop);};},[i]);return(0,F.jsxs)(`div`,{className:`min-h-screen bg-[#F8FAFC] text-slate-900 font-sans selection:bg-emerald-500 selection:text-white`,children:[i===`onboarding`&&(0,F.jsx)(Mt,{business:n||O.createBusiness({name:`New Kenyan Business`,businessType:`Retail`,county:`Nairobi`}),onFinish:p}),i===`dashboard`&&n&&(0,F.jsx)(Jt,{business:n,onLogout:m,onGoToLanding:()=>a(`landing`)}),i.startsWith("feature-")&&(0,F.jsxs)("div",{className:"flex flex-col min-h-screen",children:[(0,F.jsx)(wt,{activeUser:e,activeBusiness:n,onOpenAuth:u,onOpenDashboard:h,onNavigateSection:function(sect){goHome(sect);}}),(0,F.jsx)("main",{className:"flex-1",children:(0,F.jsx)(FeatureDetailPageComponent,{pageKey:i.replace("feature-",""),onNavigateHome:function(){goHome("features");},onNavigateFeature:function(newFeatKey){goToFeature(newFeatKey);},onOpenRegister:function(){u("register");},onOpenDashboard:h})}),(0,F.jsx)(At,{onNavigateSection:function(sect){goHome(sect);},onOpenAuth:u})]}),i===`landing`&&(0,F.jsxs)(`div`,{className:`flex flex-col min-h-screen`,children:[(0,F.jsx)(wt,{activeUser:e,activeBusiness:n,onOpenAuth:u,onOpenDashboard:h,onNavigateSection:g}),(0,F.jsxs)(`main`,{className:`flex-1`,children:[(0,F.jsx)(Tt,{onStartFreeTrial:()=>u(`register`),onWatchDemo:h,onSelectFeaturePill:e=>{g(`showcase`)}}),(0,F.jsx)(Et,{onLearnMore:goToFeature,onOpenRegister:()=>u(`register`)}),(0,F.jsx)(HowItWorksSectionComponent,{onOpenRegister:()=>u(`register`),onOpenDashboard:h}),(0,F.jsx)(Dt,{onOpenDashboard:h,onOpenRegister:()=>u(`register`)}),(0,F.jsx)(TestimonialsSectionComponent,{}),(0,F.jsx)(Ot,{newsArticles:O.getNews(),trainingCourses:O.getCourses(),onSelectArticle:()=>h(),onSelectCourse:()=>h(),onExploreMore:h}),(0,F.jsx)(WhyChooseBizHubSectionComponent,{}),(0,F.jsx)(TrustSecurityStripComponent,{}),(0,F.jsx)(kt,{onSelectPlan:()=>u(`register`)}),(0,F.jsx)(FAQSectionComponent,{onOpenAuth:u}),(0,F.jsx)(FinalCTAComponent,{onStartFreeTrial:()=>u(`register`),onExploreDemo:h}),(0,F.jsx)(ContactSectionComponent,{})]}),(0,F.jsx)(At,{onNavigateSection:g,onOpenAuth:u}),(0,F.jsx)(`div`,{className:`fixed bottom-5 right-5 z-40`,children:(0,F.jsxs)(`button`,{onClick:h,className:`px-5 py-3 rounded-2xl bg-gradient-to-r from-emerald-700 via-emerald-600 to-[#0B192C] text-white font-bold text-xs sm:text-sm flex items-center gap-2 shadow-2xl hover:scale-105 transition-all border border-emerald-400/40 cursor-pointer`,children:[(0,F.jsx)(`span`,{className:`w-2.5 h-2.5 rounded-full bg-amber-400 animate-ping`}),(0,F.jsx)(`span`,{children:`Launch BizHubKE App Dashboard`})]})})]}),(0,F.jsx)(jt,{isOpen:o,initialMode:c,onClose:()=>s(!1),onSuccess:d,onStartOnboarding:f})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,F.jsx)(_.StrictMode,{children:(0,F.jsx)(I,{})}));